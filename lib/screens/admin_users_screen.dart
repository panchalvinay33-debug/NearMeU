...
class _AdminUsersScreenState extends State<AdminUsersScreen> {
  ...
  Future<void> _changeSuspendedStatus(AppUser user) async {
    final bool newStatus = !user.isSuspended;
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          title: Text(
            newStatus ? 'Suspend User?' : 'Restore User?',
          ...
          actions: [
            ...
            TextButton(
              ...
              child: Text(
                newStatus ? 'Suspend' : 'Restore',
                style: TextStyle(
                  color: newStatus ? Colors.redAccent : Colors.green,
                ),
              ),
            ),
          ],
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(newStatus ? 'User suspended' : 'User restored')),
      );
    } catch (e) {
      if (!mounted) return;
        ...
        children: [
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search nickname or email',
          ...
          Expanded(
            child: StreamBuilder<List<AppUser>>(
              stream: _userService.getAllUsersForAdmin(),
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final firstLetter = user.nickname.trim().isNotEmpty
