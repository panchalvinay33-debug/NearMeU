...
4. [`EXECUTION_BATCH_PLAN.md`](EXECUTION_BATCH_PLAN.md) — despite the historical filename, this now contains the direct V1 launch execution plan and no numbered future batch roadmap.
5. [`TEST_BATCH_REGISTER.md`](TEST_BATCH_REGISTER.md) — despite the historical filename, this now contains the V1 launch verification register.
6. [`PRODUCT_DECISIONS.md`](PRODUCT_DECISIONS.md) — only product behavior required for the present V1 launch.
7. [`V2_AFTER_LAUNCH.md`](V2_AFTER_LAUNCH.md) — boundary for all non-launch work; no detailed V2 roadmap is active.
8. [`../README.md`](../README.md) — concise repository entry point.
...
- [`PRODUCTION_RELEASE_RUNBOOK.md`](PRODUCTION_RELEASE_RUNBOOK.md) — release mechanics reference; the V1 checklist remains authoritative for what must be fixed before launch.
...
5. README and this index
6. topic-specific technical runbooks
7. old plans, old PR descriptions and historical commits
